...
const DashboardStudentPage = ({ user, userType, oldSchoolSettings, currentStudentClassAndArm }) => {
  return  (
...
export const getServerSideProps = wrapper.getServerSideProps(
  async (ctx ) => {
    try {
      ...
      await store.dispatch(getStudentClassAndArmRequest(data.decodedToken.admissionNumber))
      ...
      return {
        props:{
           ...
           currentStudentClassAndArm :propStore.student.currentStudentClassAndArm
        }
      } 
    } catch (error) {
