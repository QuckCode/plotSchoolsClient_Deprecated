    ...
    try {
      ...
      return {
        props:{
           ...
           classes:propStore.classes.classes.length, scratchCard:100,
           staffs:propStore.staff.staffs.length, graphStudentClassTotal:propStore.student.graphOfTotalParClass,
           loading:propStore.student.loading,userType:propStore.auth.user.userType,
