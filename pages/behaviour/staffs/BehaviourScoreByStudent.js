...
const BehaviourScoreByStudent = (props) => {
   ...
   const handleScoreChange = (e, c) => {
      if (e == 0) {
         let scoreIndex = dataSource[position - 1].behaviours.findIndex(
            (a) => a._id === c._id
         );
         let scoreList = dataSource.slice();
         scoreList[position - 1].behaviours[scoreIndex] = {
            ...scoreList[position - 1].behaviours[scoreIndex],
            score: parseInt(e),
            hasScore: false,
         };
            ...
            return (
               <div style={{ textAlign: "center" }}>
                  <Select
                     ...
                     className={x == 0 ? "ant-select-selection-search" : "test"}
                     style={{ width: 120 }}
                  >
   ...
   const getStudentBehaviourScore = (value) => {
      return props
         .fetchStudentBehaviourScore(value)
         .then((x) => {
   ...
   const onConfirm = () => {
      Axios.post(
         `${url}/student/arm/behaviour/score/save`,
      ...
      <>
         ...
         >
            <div className="p-2">
               {hiddenTable ? (
                  <BehaviourScoreForm
                     getScore={getStudentBehaviourScore}
                        ...
                        <Row gutter={[48, 48]}>
                           <Col xs={24} lg={12} span={12}>
                              <Table
                                 ...
                                 dataSource={
                                    dataSource.length > 0
                                       ? dataSource[position - 1].behaviours
                                       : []
                                 }
                              />
                           </Col>
