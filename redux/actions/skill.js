...
export const getCurrentSectionSkill = (sectionId) => {
   return (dispatch) => {
      ...
      return axios
         .get(`${url}/section/skill/${sectionId}`)
         .then(({ data }) => {
...
export const addSectionSkill = (data) => {
   return (dispatch) => {
      ...
      return axios
         .post(`${url}/section/skill/add`, data)
         .then(({ data }) => {
...
export const removeSectionSkill = (data) => {
   return (dispatch) => {
      ...
      return axios
         .post(` ${url}/section/skill/remove`, data)
         .then(() => {
...
export const fetchStudentSkillScore = (data) => {
   return (dispatch) => {
      ...
      return axios
         .post(` ${url}/student/arm/skill/score`, data)
         .then(({ data }) => {
