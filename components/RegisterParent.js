   ...
   render() {
      ...
      return (
         <Form onSubmit={this.handleSubmit}>
            ...
            <FormItem required {...formItemLayout} label="Residence Address">
               {form.getFieldDecorator("homeAddress", {
                  rules: [
                     {
                        required: true,
                        message: "Please input  the residence address",
                     },
                  ],
               })(<Input.TextArea />)}
            </FormItem>
            ...
            >
               {form.getFieldDecorator("officeAddress", {
                  rules: [
                     {
                        required: true,
                        message: "Please input  the Office Address address",
                     },
                  ],
               })(<Input.TextArea />)}
            </FormItem>
            ...
            >
               {form.getFieldDecorator("password", {
                  rules: [
                     {
                        required: true,
                        message: "Please input  the password address",
                     },
                  ],
               })(<Input.Password />)}
            </FormItem>
