         ...
         const isJPG = file.type === 'image/jpeg' || file.type === 'image/png';
            if (!isJPG) {message.error('You can only upload JPG or PNG file!'); 
             ...
             <p className="ant-upload-drag-icon">
                ...
                <p className="ant-upload-text"> {process.env.school}or drag file to this area to upload</p>
            <p className="ant-upload-hint"> rrrr for a single or bulk upload. Strictly prohibit from uploading   company data or other band files</p>
          </Dragger>    
        </FormItem>
