         ...
         <Row gutter={16}>
            <Col xs={24} sm={12} md={6}>
               <StatCard
                  ...
                  clickHandler={() =>
                     message.info(`This term is currently ${section}`)
                  }
               />
            </Col>
            <Col xs={24} sm={12} md={6}>
            ...
            <Col xs={24} sm={12} md={6}>
               <StatCard
                  ...
                  clickHandler={() =>
                     message.info(`You have ${smsBalance} Sms Units `)
                  }
               />
            </Col>
            <Col xs={24} sm={12} md={6}>
            ...
            <Col xs={24} sm={12} md={6}>
               <StatCard
                  ...
                  color={theme.primaryColor}
                  clickHandler={() =>
                     message.info(`You have ${students} students`)
                  }
               />
            </Col>
            <Col xs={24} sm={12} md={6}>
            ...
            <NoSSR>
               <Legend>
                  <DiscreteColorLegend
                     width={400}
                     height={20}
                     items={[{ title: "Student", color: "#007bff" }]}
                  />
               </Legend>
               <div className="chat">
                  <FlexibleWidthXYPlot
                  ...
                  >
                     ...
                     <VerticalBarSeries
                        ...
                        onValueClick={() =>
                           message.info(`${value.x} has ${value.y} students`)
                        }
