...
class SectionForm extends React.Component {
  ...
  componentDidMount (){
    ...
    form.setFields({
      ...
      email:{value:email },schoolId:{value:schoolId},  term:{value:"First"}, schoolPrefix:{value:schoolPrefix}
    })
    ...
    return (
      ...
      <FormItem hidden={true} name="schoolId"   required {...formItemLayout} label="School Id">
        ...
        <FormItem     required  {...formItemLayout} label="Term">
           {form.getFieldDecorator('term', {  initialValue: "First" ,rules: [ {required: true,message: 'Please input Term'}] })(
            <Select  disabled>
