...
class EditSchoolForm extends React.Component {
   componentDidMount() {
      ...
      form.setFields({
         ...
         term: { value: term },
         schoolPrefix: { value: schoolPrefix },
      });
      const nextSection = `${new Date().getFullYear() + 1}/${
         new Date().getFullYear() + 2
      }`;
      if (previousSchoolSection === undefined) {
      ...
      return this.setState({
         sections: [previousSchoolSection, , section, nextSection],
      });
   }
         ...
         <div className="p-4">
            <Form onSubmit={this.handleSubmit}>
               ...
               <FormItem
                  ...
                  label="School Prefix"
               >
                  {form.getFieldDecorator("schoolPrefix", {
                     rules: [
                        {
                           required: true,
                           message: "Please input  School Prefix",
                        },
                     ],
                  })(<Input disabled />)}
               </FormItem>
               ...
               >
                  {form.getFieldDecorator("phoneNumber", {
                     rules: [
                        {
                           required: true,
                           message: "Please input School Phone",
                        },
                     ],
                  })(<Input />)}
               </FormItem>
               ...
               >
                  {form.getFieldDecorator("section", {
                     ...
                     rules: [
                        {
                           required: true,
                           message: "Please input School Sections",
                        },
                     ],
                  })(
                     <Select disabled>
